...
var userInfo = {
    userName: "李莎" , 
    userPortrait:"images/icon/intro.png",
    jobWant:  "前端开发",
    userQQ:  "627655407",
    userEmail:   "lisha0839@163.com",
    motto:  "熟练使用HTML、CSS进行页面重构，并有效解决浏览器兼容问题；熟悉JavaScript、JQuery、zepto.js、fullpage.js，熟悉移动端开发，熟练git，对前端充满兴趣，目前正在学习Vue、webpack", 
